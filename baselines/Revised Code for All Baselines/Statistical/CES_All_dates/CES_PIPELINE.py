...
class FixedCESProcessor:
    ...
    def create_fixed_model(self, df_long, h, window, freq="W-SAT", level=[80, 95], season_length=1):
...
final_result.to_csv('final_result_CES_{}.csv'.format(window))
